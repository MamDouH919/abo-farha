...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://sabaghinkuwait.com/asbagh-abwab-khashabia',
    },
}
            ...
            <Stack my={5} spacing={3} alignItems={"center"}>
                ...
                <Stack alignItems="center" spacing={2}>
                    ...
                    <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                        صباغ ابواب خشب - صباغ ابواب خشب في الكويت - صباغ ممتاز ابواب خشب - صباغ فني ابواب خشب في الكويت - 50303335
                    </Typography>
