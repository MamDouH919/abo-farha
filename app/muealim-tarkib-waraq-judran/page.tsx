...
const title = "معلم تركيب ورق جدران"

export const metadata: Metadata = {
    title: `صباغ الكويت - 50303335 - صباغ شاطر ورخيص - ${title}`,
    keywords: `صباغ الكويت, صباغ شاطر, صباغ رخيص, اصباغ داخلية وخارجية, صباغ في الكويت, اصباغ حديثة, صباغ الكويت بأفضل الأسعار, ${title}`,
    alternates: {
        canonical: 'https://sabaghinkuwait.com/tarkib-waraq-judran',
    },
}
            ...
            <Stack my={5} spacing={3} alignItems={"center"}>
                ...
                <Stack alignItems="center" spacing={2}>
                    ...
                    <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                        تركيب ورق جدران - فني تركيب ورق جدران - معلم تركيب ورق جدران في الكويت - ورق جدران الكويت - 50303335
                    </Typography>
