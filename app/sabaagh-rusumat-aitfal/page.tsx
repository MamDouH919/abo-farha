...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://sabaghinkuwait.com/sabaagh-rusumat-aitfal',
    },
}
            ...
            <Stack my={5} spacing={3} alignItems={"center"}>
                ...
                <Stack alignItems="center" spacing={2}>
                    ...
                    <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                        صباغ رسومات اطفال صباغ ممتاز رسومات اطفال - صباغ شاطر رسومات اطفال - صباغ فني رسومات اطفال - 50303335
                    </Typography>
